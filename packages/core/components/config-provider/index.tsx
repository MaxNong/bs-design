...
import { RenderEmptyHandler as _RenderEmptyHandler} from './renderEmpty';
import LocaleProvider, { ANT_MARK, Locale } from '../locale-provider';
import LocaleReceiver from '../locale-provider/LocaleReceiver';
import {
  ConfigConsumer,
  ConfigContext,
  CSPConfig as _CSPConfig,
  DirectionType as _DirectionType,
  ConfigConsumerProps as _ConfigConsumerProps,
  Theme,
} from './context';
...
export type RenderEmptyHandler = _RenderEmptyHandler
export type CSPConfig = _CSPConfig
export type DirectionType = _DirectionType
export type ConfigConsumerProps = _ConfigConsumerProps
